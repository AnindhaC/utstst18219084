...
SECRET_KEY = "a0f859aae21428498e5b40558242eacef5a467bf3a6a4a732ea7e58b2ba2c40f"
ALGORITHM = "HS256"
...
users_db = {
    "asdf": {
        ...
        "hashed_password": "$2a$04$AsyXgWdojFDnxZMnS5EhR.8FQCAjf3laP6oAXtPXLXhMOSJ9grfeO",
        "disabled": False,
    }
}
...
async def add_menu(item_id:int, name:str, valid:bool = Depends(oauth2_scheme)):
	id = len(data['menu']) + 1
	createdItem = {'id': item_id, 'name':name}
